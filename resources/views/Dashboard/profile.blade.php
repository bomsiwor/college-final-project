                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{ $user->student_name }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Program Studi</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->study_program->name }}</div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{ $user->student_address }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">No. Telp</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->student_phone }}</div>
                                    </div>
