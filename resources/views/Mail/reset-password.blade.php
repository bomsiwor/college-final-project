                                            ...
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        Halo, email ini dikirim karena permintaan untuk
                                                                        mereset kata sandi. Abaikan jika ini bukan anda.
                                                                        <br>
                                                                        Kata sandi baru : <b>{{ $newPassword }}</b>
                                                                        <br>
                                                                        Silakan langsung mengganti kata sandi anda
                                                                        melalui menu profil.
                                                                    </p>
                                                                    <table class="s-4 w-full" role="presentation"
                                                                            ...
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;"
                                                                                    ...
                                                                                    <a href="{{ route('dashboard.profile') }}"
                                                                                        style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Login
                                                                                        Sekarang</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                    ...
                                                    <div class="text-muted text-center" style="color: #718096;"
                                                        align="center">
                                                        Dikirim oleh Laboratorium Instrumentasi Nuklir <br>
                                                        Poltek Nuklir <br>
                                                        2023
                                                    </div>
                                                    <table class="s-6 w-full" role="presentation" border="0"
